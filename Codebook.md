...
The "aveMeanandStd" dataset was created from the Human Activity Recognition Using Smartphones Dataset
Version 1.0. This dataset is the average value of all the mean and standard deviation (std) variables for each subject and activity type. - refer to the Study Design section for more information
